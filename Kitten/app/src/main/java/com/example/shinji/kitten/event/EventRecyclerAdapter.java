...
//        holder.chkBox.setChecked(jobList.get(position).isSelected());
        ...
        holder.event_time.setText(event.getHoldTime());
...
//        holder.event_image.setImageBitmap();
    ...
    class EventHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public EventHolder(View itemView) {
            super(itemView);
            event_title = (TextView) itemView.findViewById(R.id.job_title);
            event_date = (TextView) itemView.findViewById(R.id.job_company);
